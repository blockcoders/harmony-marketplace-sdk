...
export const HARMONY_RPC_SHARD_0 = {
    url: 'https://api.harmony.one',
    chainId: ChainID.HmyMainnet,
    chainType: ChainType.Harmony,
};
export const HARMONY_RPC_SHARD_1 = {
    url: 'https://s1.api.harmony.one',
    chainId: ChainID.HmyMainnet,
    chainType: ChainType.Harmony,
};
export const HARMONY_RPC_SHARD_2 = {
    url: 'https://s2.api.harmony.one',
    chainId: ChainID.HmyMainnet,
    chainType: ChainType.Harmony,
};
export const HARMONY_RPC_SHARD_3 = {
    url: 'https://s3.api.harmony.one',
    chainId: ChainID.HmyMainnet,
    chainType: ChainType.Harmony,
};
export const HARMONY_RPC_SHARD_0_TESTNET = {
    url: 'https://api.s0.b.hmny.io',
    chainId: ChainID.HmyTestnet,
    chainType: ChainType.Harmony,
};
export const HARMONY_RPC_SHARD_1_TESTNET = {
    url: 'https://api.s1.b.hmny.io',
    chainId: ChainID.HmyTestnet,
    chainType: ChainType.Harmony,
};
export const HARMONY_RPC_SHARD_2_TESTNET = {
    url: 'https://api.s2.b.hmny.io',
    chainId: ChainID.HmyTestnet,
    chainType: ChainType.Harmony,
};
export const HARMONY_RPC_SHARD_3_TESTNET = {
