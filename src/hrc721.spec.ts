...
describe('HRC721 Contract Interface', () => {
  ...
  describe('balanceOf', () => {
    it('should get the number of tokens in the specified account', async () => {
      ...
      const call = await contract.balanceOf(TEST_ADDRESS_1, TX_OPTIONS)
  ...
  describe('approve', () => {
    ...
    it('should throw an error if to is not provided', async () => {
      const stub = sinon.stub(contract, 'send').withArgs('approve', ['', TOKEN_GOLD], TX_OPTIONS)
      stub.rejects()
    ...
    it('should throw an error if tokenId is not provided', async () => {
      const stub = sinon.stub(contract, 'send').withArgs('approve', [TEST_ADDRESS_1, ''], TX_OPTIONS)
      stub.rejects()
    ...
    it('should throw an error if txOptions are not provided', async () => {
      const stub = sinon.stub(contract, 'send').withArgs('approve', [TEST_ADDRESS_1, TOKEN_GOLD])
      stub.rejects()
    ...
    it('should throw an error if params are not provided', async () => {
      const stub = sinon.stub(contract, 'send').withArgs('approve', [])
      stub.rejects()
